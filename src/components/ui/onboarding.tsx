// Adapted from Cult UI's Onboarding (MIT, github.com/nolly-studio/cult-ui),
...
//
// Deviations from upstream: button import remapped from
// "@/components/ui/button" to "./button". Upstream already uses `data-slot`
// attributes and theme-token colors throughout, so no further changes were
// needed.
"use client"
